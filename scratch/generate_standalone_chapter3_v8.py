...
def generate_standalone_chapter():
    output_path = "/home/usain/Bureau/Chapitre_3_Final_A_COPIER.docx"
    print(f"Génération d'un document TOTALEMENT NOUVEAU V8 : {output_path}")
    ...
    try:
        ...
        for filename, caption_text in uc_files:
            ...
            if os.path.exists(path):
                ...
                p_src.paragraph_format.space_after = Pt(24)
        ...
        if os.path.exists(class_diag):
            ...
            p_source.paragraph_format.space_after = Pt(24)
            run_source = p_src.add_run("Source : L'auteur")
            run_source.font.size = Pt(8)
        ...
        print("Fichier grand format regénéré de zéro !")
