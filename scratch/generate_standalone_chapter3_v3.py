    ...
    try:
        ...
        for filename, caption_text in uc_files:
            ...
            if os.path.exists(path):
                # Espace naturel, pas de saut de page forcé ici
                p_img = doc.add_paragraph()
                p_img.alignment = WD_ALIGN_PARAGRAPH.CENTER
                # Taille réduite (5.0 pouces) pour permettre de regrouper plusieurs images par page
                p_img.add_run().add_picture(path, width=Inches(5.0))
        ...
        if os.path.exists(class_diag):
            p_img = doc.add_paragraph()
            p_img.alignment = WD_ALIGN_PARAGRAPH.CENTER
            p_img.add_run().add_picture(class_diag, width=Inches(5.0))
        ...
        print("Fichier regénéré avec taille compactée (5.0 Inches) !")
