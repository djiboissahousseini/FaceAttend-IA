...
def generate_standalone_chapter():
    output_path = "/home/usain/Bureau/Nouveau_Rapport_Diagrammes.docx"
    print(f"Génération d'un document autonome V7 (Grand Format) : {output_path}")
    ...
    try:
        ...
        print("Fichier grand format regénéré !")
